...
dif2<-topTable(fit2,coef="del80del4-del80",n=nrow(fit2),lfc=log2(4),adjust="BH")## Extract a table of the top-ranked genes from a linear model fit. lcf: minimum absolute log2-fold-change required. topTable and topTableF include only genes with (at least one) absolute log-fold-changes greater than lfc.
