...
binterc.upge <- binterc.genes[binterc.up,] # 114 genes upregulated in the BintersectC; 41 super sure
...
onlyc.upge <- onlyc[onlyc.up,] # 525 set in the onlyCwoB (Pho4 inde PSR genes)
...
# 8. Find Pho4 redundant targets(not mainly regulated by Pho4)
```{r}


```
# X. visualize DEGs dynamics in wt and del80 groups
```{r}
...
### BinterC Part of Pho4 indirect targets(PSR) 41 genes
...
### OnlyCwoB Pho4 inde targets(PSR) 525 gebes
