...
dif2<-topTable(fit2,coef="Tre20min-Pre",n=nrow(fit2),lfc=log2(2),adjust="BH")## Extract a table of the top-ranked genes from a linear model fit. lcf: minimum absolute log2-fold-change required. topTable and topTableF include only genes with (at least one) absolute log-fold-changes greater than lfc.
