...
dif7<-topTable(fit.del4,coef=c("del4vsdel4.20min","del4vsdel4.30min","del4vsdel4.45min","del4vsdel4.60min","del4vsdel4.90min","del4vsdel4.120min","del4vsdel4.150min","del4vsdel4.180min","del4vsdel4.240min"),n=nrow(fit.del4),lfc=log2(2),adjust="BH")
dif8<-dif7[dif7[,"adj.P.Val"]<0.05,]
write.table(dif8,file="del4-DEGs.txt",sep='\t',quote=F,row.names=F)
### screen del80 DEGs
...
### mildly induced genes
myGenePlot(genes = c("CAGL0G07188g","CAGL0G04785g","CAGL0E05654g","CAGL0K10340g","CAGL0L03377g","CAGL0K04785g","CAGL0I03872g","CAGL0J11176g"))
myGenePlot(genes = c("CAGL0K04499g","CAGL0M12925g","CAGL0K08668g","CAGL0G06182g","CAGL0B01100g","CAGL0C03872g","CAGL0C03245g"))
myGenePlot(genes = c("CAGL0E05456g","CAGL0K01155g","CAGL0A01804g","CAGL0L07700g"))
myGenePlot(genes = c("CAGL0H05995g","CAGL0K08036r","CAGL0F00341g","CAGL0I10098g","CAGL0L13354g","CAGL0M06889r","CAGL0I02596g","CAGL0K11638g","CAGL0G01716g","CAGL0H09636g"))
myGenePlot(genes = c("CAGL0L10912g","CAGL0I08943g","CAGL0I09702g","CAGL0I09284g","CAGL0C04719g","CAGL0L12144g","CAGL0D01980g","CAGL0B04675g","CAGL0H07887g","CAGL0D01837g","CAGL0J07953r","CAGL0L06644g"))
myGenePlot(genes = c("CAGL0A03586g","CAGL0L10142g","CAGL0G08624g","CAGL0J02948g","CAGL0L07766g","CAGL0B02453g","CAGL0K04037g"))
myGenePlot(genes = c("CAGL0D01276g","CAGL0E01749g","CAGL0K09878g","CAGL0M13717g","CAGL0H05379g","CAGL0G08426g","CAGL0K01683g"))
```
# 7.1 visualize mildly induced DEGs according to clustered heatmap of lfc=log2(4)&P<0.05 of wt DEGs, FC value was set to be saturated to 4.
```{r}
## this file contains subfunctions to be sourced into the main analysis for Ex009
sample[,Timepoint:=factor(Timepoint, levels = c("pre","20m","30m","45m","60m","90m","120m","150m","180m","240m"))] ## ,"del80"
sample[,Group:=paste(Genotype,Timepoint, sep=".")]
