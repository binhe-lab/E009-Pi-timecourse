...
fit.all <- eBayes(fit0)
```
## 5.2 Get the DEGs list for pho4 targets candidates
```{r}
...
```
## 5.3 Get the DEGs that are not Pho4 dependent (TMM-all)
```{r}
### log2(1.8),p<0.01 wt
...
dif044<-dif033[dif033[,"adj.P.Val"]<0.01,]
...
dif066<-dif055[dif055[,"adj.P.Val"]<0.01,]
...
se016 <- subset(se01,av.minus>=0.6) # 123 genes
se017 <- subset(se01,av.minus>=1)  # 95 genes
se018 <- subset(se01,av.minus>=1.5) # 59 genes

se6 <- subset(se5,av.minus>=0.6) # 681 genes
se7 <- subset(se5,av.minus>=1) # 425 genes
se8 <- subset(se5,av.minus>=1.5) # 232 genes
se9 <- subset(se5,av.minus>=2) # 113 genes
se61 <- subset(se6,ded>0.6) #146 genes
se62 <- subset(se6,ded>1) # 68 genes
se63 <- subset(se6,ded>1.5) #32 genes
se71 <- subset(se7,ded>0.6) # 111 genes
se72 <- subset(se7,ded>1)   # 56 genes
se73 <- subset(se7,ded>1.5) # 27 genes
se81 <- subset(se8,ded>0.6) # 65 genes
se82 <- subset(se8,ded>1)   # 40 genes
se83 <- subset(se8,ded>1.5) # 19 genes
se91 <- subset(se9,ded>0.6) # 31 genes
se92 <- subset(se9,ded>1)   # 24 genes
se93 <- subset(se9,ded>1.5) # 15 genes

sex03 <- subset(se03,av.minus<0.6) # 17 genes
```
...
```
## 7.0 (TMM-all) phosphate starvation response related DEGs independent to Pho4
```{r}
...
```{r}
### lately se92
myGenePlot(genes = c("CAGL0L06644g","CAGL0I00748g","CAGL0J04884g","CAGL0G09262g","CAGL0E05984g","CAGL0L04686g","CAGL0J04202g","CAGL0G02057g","CAGL0M02915g"))
myGenePlot(genes = c("CAGL0G05984g","CAGL0E00275g","CAGL0F04631g","CAGL0E03366g","CAGL0C00209g","CAGL0D04400g","CAGL0J00451g","CAGL0M03305g","CAGL0A03586g"))
myGenePlot(genes = c("CAGL0L09295g","CAGL0K13002g","CAGL0G02739g","CAGL0M06889r","CAGL0B01100g","CAGL0A03905g"))
### lately se93
myGenePlot(genes = c("CAGL0L06644g","CAGL0I00748g","CAGL0E05984g","CAGL0G02057g","CAGL0M02915g","CAGL0G05984g","CAGL0E00275g"))
myGenePlot(genes = c("CAGL0E03366g","CAGL0C00209g","CAGL0D04400g","CAGL0M03305g","CAGL0A03586g","CAGL0L09295g","CAGL0G02739g","CAGL0A03905g"))
### early sex03
myGenePlot(genes = c("CAGL0G06952g","CAGL0J07040g","CAGL0L05456g","CAGL0F02145g","CAGL0M12705g","CAGL0D04378g","CAGL0M08822g","CAGL0L06622g","CAGL0H01177g"))
myGenePlot(genes = c("CAGL0B03014g","CAGL0F02387g","CAGL0M05137g","CAGL0B02970g","CAGL0B02981g","CAGL0M02871g","CAGL0I04015r","CAGL0L07194g"))
```
## 7.1 TMM-all
```{r}
### TMM-all >=log2(2.5) FC
